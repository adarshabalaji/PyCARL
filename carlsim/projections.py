...
class Projection(common.Projection):
	...
	if isinstance(synapse_type.parameter_space['delay'].base_value, float):
	...
	simulator.state.network.connect(presynaptic_population.carlsim_group, postsynaptic_population.carlsim_group, nameMapping[connector.__class__.__name__], RangeWeight(0,weight,maxWt),prob,RangeDelay(delay), RadiusRF(-1), plasticity)
