...
# TO BUILD FOR PYTHON3
 ...
 python3 setup.py build_ext --inplace --define __NO_CUDA__ --include ../../CARLsim4/carlsim/kernel/inc/:../../CARLsim4/carlsim/monitor/:../../CARLsim4/carlsim/interface/inc/:../../CARLsim4/tools/spike_generators/
